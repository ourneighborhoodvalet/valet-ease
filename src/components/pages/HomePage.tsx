  ...
  return (
    <div className="min-h-screen bg-background font-paragraph overflow-x-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 pt-24 pb-16 lg:pb-24 xl:pb-32 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">Neighborhood Valet -Trash & Amenity Services for Apartments, Condos & Multifamily Communities</div>
