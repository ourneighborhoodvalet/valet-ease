  ...
  return (
    <div className="min-h-screen bg-background font-paragraph overflow-x-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-[0.95] shadow-[12px_12px_4px_0px_#d9d9d9]">
          <Image 
            src="https://static.wixstatic.com/media/e622ff_07851b8bdf4949319123806fe9252bda~mv2.png?originWidth=1280&originHeight=704" 
            alt="Neighborhood Valet Services team at work" 
            ...
            <div className="lg:col-span-1">
              ...
              <AnimatedSection delay={500}>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-10">
                  <button onClick={() => navigate('/property-managers')} className="group flex items-center space-x-4 text-white hover:text-accent transition-colors duration-300">
            ...
            <div className="lg:col-span-1 flex justify-center lg:justify-end">
              <AnimatedSection delay={900} direction="right">
                <div className="relative w-full max-w-sm aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl border border-white/20">
                  <Image src="https://static.wixstatic.com/media/e622ff_07851b8bdf4949319123806fe9252bda~mv2.png?originWidth=1280&originHeight=704" alt="Neighborhood Valet Services team at work" className="w-full h-full object-cover scale-110" />
                  ...
                  <div className="absolute bottom-8 left-8 right-8 bg-white/90 backdrop-blur-md p-6 rounded-xl shadow-lg border border-white/20 text-center">
                    <p className="text-sm text-muted-foreground uppercase tracking-wider font-semibold mb-2">Service Standard</p>
                    <p className="text-4xl font-bold text-primary font-heading">5</p>
                    <p className="text-sm text-muted-foreground uppercase tracking-wider font-semibold mt-1">Nights / Week</p>
                  </div>
                </div>
              </AnimatedSection>
            </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <AnimatedSection>
            ...
            <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto font-light">
              Join thousands of satisfied property managers and residents who trust Neighborhood Valet for their amenity services.
            </p>
