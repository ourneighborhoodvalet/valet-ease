          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                {
                  icon: Award,
                  title: 'Premium Local Service',
                  description: 'Built for clear expectations, clean pickups, and fast issue resolution'
                },
                {
                  icon: BarChart3,
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <Card className="p-8 bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
                  ...
                  <p className="text-xl font-heading text-foreground">Nights / Week</p>
                </Card>
                <Card className="p-8 bg-gradient-to-br from-accent/5 to-primary/5 border-accent/20">
                  <div className="text-5xl font-bold text-accent mb-2">Fast</div>
                  <p className="text-xl font-heading text-foreground">Issue Follow‑Up</p>
                </Card>
                <Card className="p-8 bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
                  <div className="text-5xl font-bold text-primary mb-2">Clear</div>
                  <p className="text-xl font-heading text-foreground">Pickup Windows</p>
                </Card>
              </div>
            </div>
          </div>
